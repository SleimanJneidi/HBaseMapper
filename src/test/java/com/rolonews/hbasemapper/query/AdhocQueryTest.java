...
public class AdhocQueryTest extends BaseTest {
	...
	@Test
	public void testGetAllRowKeysOnly() throws IOException {
		...
		// fetched columns
		assertEquals(0, result.get(0).object().keySet().size());
		assertEquals(0, result.get(1).object().keySet().size());
		assertEquals(0, result.get(2).object().keySet().size());
	}
	...
	public void testGetSome() throws IOException{
		...
		// fetched columns
		assertEquals(2, result.get(0).object().keySet().size());
		assertEquals(2, result.get(1).object().keySet().size());
		assertEquals(2, result.get(2).object().keySet().size());
